...
class CResonantLPFwMassberg : public CPlugIn
{
public:
	...
	CResonantLPFwMassberg();

	// 2. One Time Destruction
	virtual ~CResonantLPFwMassberg(void);
	...
	void calculateLPFCoeffs(float fCutoffFreqm, float fQ);
	void calculateMassbergLPFCoeffs(float fCutoffFreqm, float fQ);
